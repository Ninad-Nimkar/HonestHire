...
def github_analyzer_node(state: TrueHireState) -> TrueHireState:
    ...
    for cand in candidates:
        ...
        # To avoid rate limits in the test, we skip searching for TODO/FIXME in all repos
        # In a real scenario we'd query /search/code?q=TODO+user:{username}
        ...
        gh_signals = GitHubSignals(
            ...
            real_collaboration=True # Mocked true for now
        )
